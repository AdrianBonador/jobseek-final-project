...
<section class="container mx-auto px-4">
    <div class="bg-white auth-card rounded-lg shadow-md">
        <h2 class="text-3xl font-bold text-center mb-2 text-primary-brand">Get Started on HireHub PH</h2>
        <p class="text-center text-gray-500 mb-6">Create your free account to apply or post jobs</p>
        ...
        <form method="POST" action="<?= url('/register') ?>">
            ...
            <button type="submit" class="w-full btn-accent py-3 rounded my-3">Create My Account</button>
        </form>

        <p class="text-center text-sm mt-4">
            Already have an account? <a href="<?= url('/login') ?>" class="text-primary-brand font-semibold">Log in</a>
        </p>
    </div>
</section>
