...
<section class="flex justify-center items-center mt-8 mb-12 px-4">
    <div class="panel w-full max-w-2xl p-8">
        <h2 class="text-3xl text-center font-bold mb-2 text-primary-brand">Post a New Job</h2>
        <p class="text-center text-gray-500 mb-6">Fill in the details below — your listing goes live instantly</p>

        <form method="POST" action="<?= url('/listings') ?>">
            <h3 class="text-xl font-bold mb-4 text-primary-brand border-b pb-2">Job Details</h3>
            <?php
            $fields = [
                'title'        => ['label' => 'Job Title',                       'type' => 'text'],
                'description'  => ['label' => 'Job Description',                 'type' => 'textarea'],
                'salary'       => ['label' => 'Annual Salary (PHP)',              'type' => 'text'],
                'requirements' => ['label' => 'Requirements',                     'type' => 'text'],
                'benefits'     => ['label' => 'Benefits & Perks',                 'type' => 'text'],
            ...
            <button type="submit" class="w-full btn-accent py-3 rounded my-3 font-semibold">Publish Job Now</button>
