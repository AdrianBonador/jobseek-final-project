...
<section class="flex justify-center items-center mt-8 mb-12 px-4">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl">
        <h2 class="text-3xl text-center font-bold mb-2 text-primary-brand">Edit Job Listing</h2>
        <p class="text-center text-gray-500 mb-6">Updating: <strong><?= e($listing->title) ?></strong></p>
        ...
        <form method="POST" action="<?= url('/listings/' . $listing->id) ?>">
            ...
            <button type="submit" class="w-full btn-accent py-3 rounded my-3 font-semibold">Save Updates</button>
