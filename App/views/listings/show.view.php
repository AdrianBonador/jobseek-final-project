...
<section class="container mx-auto p-4 pb-8">
    <h2 class="text-xl font-semibold mb-3 text-primary-brand" style="font-family: var(--font-heading);">More About This Role</h2>
    <div class="panel p-6 mb-6">
        <h3 class="font-semibold mb-2 text-primary-brand">What You'll Need</h3>
        <p class="text-gray-700 leading-relaxed"><?= e($listing->requirements ?: 'Reach out to the employer for full requirements.') ?></p>
        <h3 class="font-semibold mt-5 mb-2 text-primary-brand">What You'll Get</h3>
        <p class="text-gray-700 leading-relaxed"><?= e($listing->benefits ?: 'Benefits will be discussed during the interview.') ?></p>
    </div>
    <div class="btn-center-wrap">
        <a href="mailto:<?= e($listing->email) ?>?subject=Application%20for%20<?= rawurlencode($listing->title) ?>"
            class="btn btn--primary">
            <i class="fa fa-paper-plane"></i> Apply Now via Email
        </a>
    </div>
</section>
